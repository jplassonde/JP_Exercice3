...
export LoadConfig_jp_exercice3
export _LoadConfig_jp_exercice3
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_DriveMode_0_SHADE], 1h
	mov		[Port_0_DriveMode_1_SHADE], feh
	mov		[Port_0_DriveMode_2_SHADE], 3eh
	mov		[Port_1_Data_SHADE], 90h
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], 7fh
	mov		[Port_2_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_jp_exercice3
	lcall	LoadConfigTBL_jp_exercice3_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration jp_exercice3
;
;    Load configuration registers for jp_exercice3.
...
;               CUR_PP
;
_LoadConfig_jp_exercice3:
 LoadConfig_jp_exercice3:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_jp_exercice3_Bank0
    mov     X, <LoadConfigTBL_jp_exercice3_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_jp_exercice3_Bank1
    mov     X, <LoadConfigTBL_jp_exercice3_Bank1
